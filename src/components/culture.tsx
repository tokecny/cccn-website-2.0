  ...
  return (
    <section id="culture" className="">
      <div className="max-w-3xl mx-auto text-center px-4 sm:px-6">
        <div>
          <h2 className="text-3xl font-semibold text-pink-500">Culture</h2>
          <p className="mb-8 text-pink-500">(And Things We Value)</p>
        </div>
        <div className="bg-white rounded-xl shadow-md p-10 hover:shadow-lg transition-all">
          <ul className="text-gray-800 text-left space-y-6 max-w-2xl mx-auto">
            ...
            <li>
              ...
              <p className="text-sm">
                Work when/where suits you – but we love spending time together
                in the lab (there might be snacks).
              </p>
            </li>
            <li>
              <strong className="text-pink-500 text-sm sm:text-base">
            ...
            <li>
              ...
              <p className="text-sm">
                We cherish diverse backgrounds – cultural, academic, personal.
                Respect and empathy are non-negotiable.
              </p>
            </li>
          </ul>
        </div>
