        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-all">
            ...
            <div className="space-y-3 text-gray-800 text-sm">
                <p>
                    🎥 <a href="https://www.youtube.com/playlist?list=PLnE-99oQBy1JKaM1hlFNjZH-drJlp0ASx" className="text-pink-500 hover:underline" target="_blank">
                    Brain Building Blocks
                    </a> : A Computational Neuroscience online course <br></br>Sponsored by <b>PMU-B</b>
                </p>
                <p>
                    🎥 <a href="https://neuromatch.io/courses/" className="text-pink-500 hover:underline" target="_blank">
                    Neuromatch Academy  
                    </a> : A global initiative in computational neuroscience education was co-founded by <b>Konrad Kording.</b>
                </p>
                <p>
                    📝 Useful and simple tips in academic manuscript by <b>Konrad Kording.</b>
                    <br></br><a href="/ten-rules.pdf" target="_blank" className="text-pink-500 hover:underline ml-1">
                    Ten simple rules for structuring papers (TH)
                    </a><br />
                    Translation by Brain Code 101 members and CCCN Lab.
                </p>
                <p>
                    🔒 <a href="https://sites.google.com/chula.ac.th/cccnlabwiki" className="text-pink-500 hover:underline" target="_blank">
                    LabWikis
                    </a> : Our little chamber for lab members. 
                </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-all">
            ...
            <div className="space-y-3 text-gray-800 text-sm">
                <p>
                    📖 <a href="https://www.the101.world/author/chaipat-chunharas/" target="_blank" className="text-pink-500 hover:underline">
                    BrainBug
                    </a> : Cognitive Neuroscience articles for a broad audience <br></br><b>@ 101.world.</b>
                </p>
                <p>
                    🎥 Dr.Sirawaj Itthipuripat and Dr.Chaipat Chunharas on 
                    <a href="https://www.youtube.com/watch?v=xDWEmsFyJCU&t=97s" target="_blank" className="text-pink-500 hover:underline ml-1">
                    the topic of Neuroscience
                    </a> <br></br><b>@ The Standard.</b> 
                </p>
                <p>
                    🎥 A casual conversation on brains  — featuring
                    <a href="https://www.youtube.com/watch?v=w9W8wivMyXo&list=PLnngDzPu334Ddj6YmFD6ADnhGk4Rfqqdm" target="_blank" className="text-pink-500 hover:underline ml-1">
                    Brain Code Cast 
                    </a> <b>@ WiTcast.</b> 
                </p>
                <p>
                    🎥 Another brainy session with Dr.Chaipat on 
                    <a href="https://www.youtube.com/watch?v=CNSAs4JOEWc" target="_blank" className="text-pink-500 hover:underline ml-1">
                    Weirdทยาศาสตร์ (EP22-23)
                    </a> <br></br><b>@ Salmon Podcast.</b> 
                </p>
                <p>
                    📖 Discover  
          ...
          <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-all">
            ...
            <div className="space-y-3 text-gray-800 text-sm">
                <p>
                    ...
                    <a href="https://drive.google.com/drive/folders/15ahhazQjqMOKNejjup31pDm-vUuAfeqv?usp=sharing" target="_blank" className="text-pink-500 hover:underline ml-1">
                    posters 
                    </a> presented by our lab members at international conferences 
                </p>
                <p>
                    🗄️ Not just research – we travel, we laugh, we celebrate. These 
                    <a href="https://drive.google.com/drive/folders/1sI1slN4qJEwv2RZkAKfi_XhkKsII2W8m?usp=sharing" target="_blank" className="text-pink-500 hover:underline ml-1">
                    albums
                    </a> are where memories live. 
                </p>
            </div>
          </div>
        </div>
